<script>
	...
	[
		...
		{ unit: 1, key: 'w', code: 'KeyW', color: '#091828' },
	...
	[
		{ unit: 1.75, key: 'CapsLock', code: 'CapsLock', color: '#091828' },
	...
	[
		{ unit: 1.5, key: 'Ctrl', code: 'ControlLeft', color: '#091828' },
		...
		{ unit: 1.75, key: 'Win', code: 'MetaRight', color: '#091828' },
...
<audio bind:this={keypress} src="/keypress.mp3"></audio>

{#if !inFocus}
    <div class="mx-auto w-full flex items-center justify-center bottom-16 absolute">
        <div class="border-2 border-blue-950 rounded-lg bg-blue-900/20 text-white p-2">
            <p class="text-xs lg:text-sm">Press any button to start typing!</p>
        </div>
    </div>
{/if}

<div class="mx-auto w-full flex flex-col items-center justify-center top-8 absolute text-white p-2">
...
<section>
	<div class="flex flex-col h-screen items-center justify-center">
        ...
        <div class="flex items-center justify-center my-8">
            <!-- <p class="text-white text-2xl font-light">&nbsp;{text}</p>
            <div class=" h-9/12 w-[2px] bg-white animate-pulse"></div> -->
            <!-- <input bind:value={text} class="h-8 focus:outline-none text-white text-2xl font-light" type="text" autofocus > -->

            <textarea onfocusout={inFocus = false} bind:this={textArea} bind:value={text} class="w-60 lg:w-3xl focus:outline-none text-white text-lg lg:text-2xl font-light resize-none overflow-hidden" cols="30" rows="4" type="text" ></textarea>
        </div>
...
<footer class="mx-auto w-full flex items-center justify-center absolute bottom-4">

		<div
			class="flex flex-col items-center justify-center space-x-8 text-center text-xs lg:text-sm font-medium text-gray-900 lg:flex-row"
		>
			<p class="font-normal text-gray-600">
                Made with ♥️ by
                <a href="https://jamal-haneef.vercel.app/" class=""
                    ><span class="font-medium text-gray-300 hover:underline decoration-gray-300 decoration-1 underline-offset-2 mx-0.5">Jamal Haneef</span></a
                >
                <a href="https://wurks.studio/" class=""
                    >& <span class="font-medium text-purple-600 hover:underline decoration-purple-600 decoration-1 underline-offset-2 ml-0.5">Wurks</span>.</a
                >
            </p>
		</div>
</footer>